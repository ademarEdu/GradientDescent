...
class Griewangk (Function):
    ...
    def Eval(self, x):
        ...
        Args:
        x (np.array type float64): n-dimensional array representing the position in the n-dimensional space where the function will be evaluated. The array should be of type float64 to avoid errors when performing calculations.
        """
        # ensure we are working with a numpy array so operations like ** work
